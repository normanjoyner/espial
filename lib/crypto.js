...
module.exports = {
    ...
    generate_dh: function(){
        ...
        console.log("my pubkey is " + pubkey.toString("hex"));
    },

    generate_dh_secret: function(requested_prime){
        var temp_dh = crypto.createDiffieHellman(requested_prime);
        temp_dh.generateKeys();
        console.log("since im the slave my pubkey for this node is: " + temp_dh.getPublicKey().toString("hex"));
        return {
